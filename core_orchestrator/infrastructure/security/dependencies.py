...
from core_orchestrator.infrastructure.security.jwt_utils import decode_token, is_token_blacklisted, get_token_jti
...
async def verify_api_key_header(
    ...
    """
    telemetry_client_service = request.app.state.telemetry_client_service
