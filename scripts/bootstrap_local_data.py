...
async def seed_users(user_service: UserService, seed_path: Path, overwrite_existing: bool) -> TelemetryBootstrapSummary:
    ...
    for user_data in users_data:
        user, created = await user_service.seed_user(
...
async def seed_telemetry_clients(telemetry_client_service: TelemetryClientService, seed_path: Path, overwrite_existing: bool) -> TelemetryBootstrapSummary:
    summary = TelemetryBootstrapSummary()
...
async def bootstrap(
    ...
    try:
        ...
        rule_service = RuleService(rule_repository=rule_repo, audit_repository=audit_repo, redis_client=db_manager.redis_client)
